                           ...
                           <div class="member">
                              ...
                              <div class="member-info">
                                 <div class="member-info-content">
                                    ...
                                    <a href="/${data.pageType}/${data.titleUrl}">
                                       <h4>${data.heading}</h4>
                                    </a>
                        ...
                        <div class="row antivirus-sec">
                           <c:forEach var="airlines" items="${airlinesData}" begin="0" end="6">
                              <div class="col-md-6 icon-box">
                                 ...
                                 <a href="/${airlines.pageType}/${airlines.titleUrl}">
                                    <h4>${airlines.heading}</h4>
                                 </a>
                     ...
                     <div class="item">
                        <div class="owl-inner-sec">
                           ...
                           <div class="slide-content">
                              ...
                              <a class="content_heading" href="/${technologys.pageType}/${technologys.titleUrl}">
