            ...
            <div class="solution_cards_box">
              <div class="solution_card">
                <div class="solu_description">
                  <a href="/es/${indexPage.pageType}/${data.titleUrl}"><h3>${data.heading}</h3></a>
                  <p>${(fn:substring(data.content.replaceAll('<.*?>' , ""), 0, 115))}</p>
                  <a href="/es/${indexPage.pageType}/${data.titleUrl}" class="mores">Más blogs <i class="bi bi-arrow-right-short"></i></a>
                </div>
              </div>
            </div>
          </div> 
