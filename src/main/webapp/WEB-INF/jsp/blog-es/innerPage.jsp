               ...
               <div class="contact-content">
                  ...
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/es/${data.pageType}">${data.pageType}</a></li>
		          ...
		          <div class="item">
		            <div class="owl-inner-sec">
		              ...
		              <div class="slide-content">
		                ...
		                <a class="content_heading" href="/es/${tech.pageType}/${tech.titleUrl}">${(fn:substring(tech.heading, 0, 45))}</a>
		              </div>
		            </div>
		           </div>
		          </c:forEach>  
                        ...
                        <div class="sidebar">
                           ...
                           <c:forEach var="datas" items="${recentArticle}" begin="0" end="6">
                              <div class="post-item clearfix">
                                 ...
                                 <h4><a href="/es/${datas.pageType}/${datas.titleUrl}">${datas.heading}</a></h4>
